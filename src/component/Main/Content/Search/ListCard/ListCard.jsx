...
const Skeleton = ({ List }) => {
	...
	return (
		<a href={List !== undefined ? `https://www.youtube.com/watch?v=${List.id.videoId}` : 'https://www.youtube.com'} className='skeleton_card' target='_blank' rel='noreferrer'>
			<img
				...
				
				{
					List !== undefined 
						? <div className='title_text'>
							...
							<p className='views'>
								<span>조회수 {new Date(List.snippet.publishedAt).getSeconds() + 1}만 회 </span>
